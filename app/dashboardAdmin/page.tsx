    ...
    tables: {
      ...
      academicCalendar: {
        ...
        fields: [
          ...
          { key: "eventType", label: "Jenis", type: "select", options: ["registration", "orientation", "classes_start", "midterm", "finalterm", "holiday", "break", "thesis_deadline", "graduation", "other"], required: true },
    ...
    tables: {
      admissionPathways: {
        ...
        fields: [
          ...
          { key: "registrationStart", label: "Mulai Pendaftaran", type: "datetime", required: true },
          { key: "registrationEnd", label: "Akhir Pendaftaran", type: "datetime", required: true },
          { key: "testDate", label: "Tanggal Tes", type: "datetime" },
          { key: "announcementDate", label: "Tanggal Pengumuman", type: "datetime" },
          { key: "registrationFee", label: "Biaya Pendaftaran", type: "number" },
          { key: "isPublished", label: "Dipublikasikan", type: "boolean" },
        ],
      },
      admissionClasses: {
